module github.com/dfang/mall/service/order/rpc

go 1.17

require (
	github.com/dfang/mall v0.0.0-20220325085147-0f334888246e
	github.com/dfang/mall/service/product/rpc v0.0.0-20220325092953-b332c2ee5565
